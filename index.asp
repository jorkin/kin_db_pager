...
<body>
<p>Kin_Db_Pager 分页类(<a href="http://jorkin.me" target="_blank">KinJAVA日志</a> <a href="http://jorkin.me/kin_db_pager" target="_blank">下载</a>) <a href="help.asp">使用帮助</a></p>
<%
'//-----------------------------------------------------------------------------
...
'//定义记录集综合信息
'oDbPager.PagerInfo = "共有 {$Kin_RecordCount} 记录 页次:{$Kin_Page}/{$Kin_PageCount}"
...
Loop
'//输出分页信息/样式/TABLE尾
Response.Write("</tr><tr><td colspan=""" & iCols & """ bgcolor=""#CCE8CF""><div style=""float:right"">" & sPager & " 下拉跳转: " & sJumpPager & " 页</div>" & sPagerInfo & "</td></tr></table>")
%>
多行多列 方法二(只填满最后一行)<br />
<%
Set oRs = oDbPager.Recordset
...
Loop
'//输出分页信息/样式/TABLE尾
Response.Write("</tr><tr><td colspan=""" & iCols & """ bgcolor=""#CCE8CF"">" & sPagerInfo & "<br />" & sPager & "<br /><font color=""blue"">&nbsp; &nbsp; 翻页链接自定义为: http://down.chinaz.com/soft/24767.htm#页数.html</font></td></tr></table>")
oRs.Close
%>
<%
'//-----------------------------------------------------------------------------
...
<div class="ajax"><%="ajax 分页 " & sPagerInfo & " " & sPager & " ajax数字分页:" & sJumpPager%></div>
<%
'//-----------------------------------------------------------------------------
'// 对该记录集的分页样式及模板进行设置(不设置则使用默认样式)
'//-----------------------------------------------------------------------------
